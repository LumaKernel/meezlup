...
export const EventFactory = {
  ...
  withRestrictions: (type: "domain" | "specific_users", restrictions: ReadonlyArray<string>, overrides: Partial<Event> = {}): Event =>
    EventFactory.create({
      participantRestrictionType: type,
      ...(type === "domain" 
        ? { allowedDomains: restrictions.map(r => Schema.decodeUnknownSync(NonEmptyString)(r)) }
        : { allowedEmails: restrictions.map(r => Schema.decodeUnknownSync(EmailString)(r)) }
      ),
      ...overrides,
    }),
};